...
| Vehicle | Image | Tracks | Default `VEHICLE` / `MODEL` |
|---------|-------|--------|-----------------------------|
| Copter  | `ghcr.io/murphy360/ardupilot-sitl-docker-copter` | `ArduCopter-stable` | `ArduCopter` / `+` |
| Plane   | `ghcr.io/murphy360/ardupilot-sitl-docker-plane`  | `ArduPlane-stable`  | `ArduPlane` / `plane` |
| Rover   | `ghcr.io/murphy360/ardupilot-sitl-docker-rover`  | `APMrover2-stable`  | `Rover` / `rover` |
| Sub     | `ghcr.io/murphy360/ardupilot-sitl-docker-sub`    | `ArduSub-stable`    | `ArduSub` / `vectored` |
